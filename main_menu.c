...
int prompt_game_mode(SDL_Renderer *renderer, TTF_Font *font)
{
    ...
    while (result == 0)
    {
        ...
        draw_mode_text(renderer, font, "Choose Game Mode", SCREEN_W / 2 - 85, SCREEN_H / 2 - 75,
        ...
        draw_mode_text(renderer, font, "1P", single.x + 55, single.y + 12,
                       (SDL_Color){255, 255, 255, 255});
        draw_mode_text(renderer, font, "2P", multi.x + 58, multi.y + 12,
                       (SDL_Color){255, 255, 255, 255});
        SDL_RenderPresent(renderer);
