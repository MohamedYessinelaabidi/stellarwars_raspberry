...
void initMenu(SDL_Renderer* renderer, TTF_Font* font, MenuButtons* buttons) {
    ...
    buttons->rectYes  = (SDL_Rect){140, 150, 100, 35};
    buttons->rectNo   = (SDL_Rect){140, 200, 100, 35};
    buttons->rectLoad = (SDL_Rect){140, 125, 100, 35};
    buttons->rectNew  = (SDL_Rect){140, 175, 100, 35};
